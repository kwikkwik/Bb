...
// Commands
       ...
       if (command === 'changelog') {
		...
		.setAuthor("Bolt Changelog | 28 Jul 2018",`https://cdn.discordapp.com/avatars/471150809196003328/a0ed47f2512655b5604a94e0cfb950ef.png?size=2048`)
       ...
       if (command === 'help') {
		...
		.addField("Utility", "`avatar`, `cinvite`, `discrim`, `img`, `invitelist`, `listemoji`, `poll`, `report`, `serverinfo`, `sgif`, `timer`, `userinfo`, `warn`, `weather`")
		.addField("Fun", "`8ball`, `bunny`, `cat`, `dog`, `flip`, `givecandy`, `lucknumber`, `mcsay`, `osu`, `rolldice`, `rps`, `say`, `sayd`, `sayembed`, `cleverbot`, `randommeme`")
