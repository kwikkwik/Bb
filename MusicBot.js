...
// Commands
       ...
       if (command === 'help') {
		...
		.addField("Utility", "`avatar`, `cinvite`, `discrim`, `fortnite`, `google`, `img`, `invitelist`, `listinvite`, `listemoji`, `math`, `mcuser`, `mcstats`, `npm`, `poll`, `report`, `serverinfo`, `sgif`, `shorten`, `timer`, `translate`, `userinfo`, `urban`, `warn`, `weather`")
		.addField("Fun", "`8ball`, `animememe`, `ask`, `beautiful`, `bunny`, `cat`, `cmm`, `dog`, `emojify`, `flip`, `gif`, `givecandy`, `lucknumber`, `mcsay`, `meme`, `osu`, `rolldice`, `rps`, `say`, `sayd`, `sayembed`, `ship`, `slot`, `cleverbot`, `randommeme`")
		.addField("Reaction", "`pat`, `hug`, `kiss`, `cry`, `slap`")
		.addField("Administration", "`addrole`, `announce`, `ban`, `kick`, `mute`, `prune|purge`, `removerole`, `setprefix`, `tempmute`")
